...
class _$TradeImpl implements _Trade {
  ...
  @override
  String toString() {
    return 'Trade(tradeId: $tradeId, senderUsername: $senderUsername, receiverUsername: $receiverUsername, pokemonCardsOffered: $pokemonCardsOffered, pokemonCardsRequested: $pokemonCardsRequested, status: $status)';
  }
...
abstract class _Trade implements Trade {
  const factory _Trade(
      ...
      required final List<PokemonCard> pokemonCardsOffered,
      required final List<PokemonCard> pokemonCardsRequested,
      required final bool status}) = _$TradeImpl;
